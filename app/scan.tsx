    ...
    return (
      <SafeAreaView className="flex-1 bg-dhe-bg">
        ...
        >
          ...
          >
            <PageContainer>
              <QrCode size={isCompactHeight ? 44 : 56} color={colors.primary} />
    ...
    <View className="flex-1 bg-dhe-bg">
      ...
      <SafeAreaView className="flex-1" pointerEvents="box-none">
        ...
        <View className="flex-1 items-center justify-center" pointerEvents="none">
          <View
            className="rounded-3xl border-2 border-dhe-primary"
          ...
          <Text
            className="mt-6 text-center text-sm text-dhe-text"
            style={{ paddingHorizontal: horizontalPadding }}
          >
            Aponte para o QR Code do equipamento
          </Text>
          <Text
            className="mt-1 text-center text-xs text-dhe-textSecondary"
            style={{ paddingHorizontal: horizontalPadding }}
          >
        ...
        <View style={{ paddingHorizontal: horizontalPadding, paddingBottom: scrollBottomPadding }}>
          {(loading || error) && (
